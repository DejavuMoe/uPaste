...
export const TextCreateForm: React.FC<TextCreateFormProps> = ({ onSuccess }) => {
    ...
    <form className="create-form text-create-form" onSubmit={handleSubmit} noValidate>
      <div className="form-toolbar">
        <div className="toolbar-group">
          {/* Format Selector */}
          <div className="segmented-control" role="radiogroup" aria-label="Text format">
            <button
              type="button"
              role="radio"
          ...
          {/* Privacy Selector */}
          <div className="segmented-control" role="radiogroup" aria-label="Privacy mode">
            <button
              type="button"
              role="radio"
        ...
        {/* Expiration Selector */}
        <div className="toolbar-expiration">
          <ExpirationField
