...
go build -o "$data/upaste" "$root/cmd/upaste"
UPASTE_ADDR=127.0.0.1:4180 UPASTE_FILE_ADDR=127.0.0.1:4181 UPASTE_FILE_ORIGIN=http://127.0.0.1:4181 UPASTE_DATA_DIR="$data" "$data/upaste" & api=$!
